...
// ModelBuilder
// 
// Reads project files and populates Domain object
// 
// ================================================================================================
...
//
// ================================================================================================
template<int nDim> std::unique_ptr<Domain<nDim>> ModelBuilder<nDim>::initMesh(std::istream& fileProj)
{
    PROFILE_FUNCTION();
    ...
    return std::make_unique<Domain<nDim>>(nNodes, nElem, nMat, nSec);
}
...
//
// ================================================================================================
template<int nDim> std::unique_ptr<SolutionAlgorithm<nDim>> ModelBuilder<nDim>::initAnalyzer(std::istream& fileProj)
{
    PROFILE_FUNCTION();
    ...
    return std::make_unique<SolutionAlgorithm<nDim>>(m_AnalysisType, NLSolverType(iSl - 1), m_ProblemType, NumLS, MinIt, MaxIt, Tol);
}
...
//
// ================================================================================================
template<int nDim> bool ModelBuilder<nDim>::populateDomain(Domain<nDim>* theDomain)
{
    PROFILE_FUNCTION();
...
//
// ================================================================================================
template<int nDim> bool ModelBuilder<nDim>::populateNodes(Domain<nDim>* theDomain)
{
    PROFILE_FUNCTION();
...
//
// ================================================================================================
template<int nDim> bool ModelBuilder<nDim>::populateMaterials(Domain<nDim>* theDomain)
{
    PROFILE_FUNCTION();
...
//
// ================================================================================================
template<int nDim> bool ModelBuilder<nDim>::populateElements(Domain<nDim>* theDomain)
{
    PROFILE_FUNCTION();
...
//
// ================================================================================================
template<int nDim> int ModelBuilder<nDim>::readBondaryConditions(Domain<nDim>* theDomain, SolutionAlgorithm<nDim>* theAnalyzer)
{
    PROFILE_FUNCTION();
