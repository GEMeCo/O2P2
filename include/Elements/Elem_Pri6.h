...
// 
// ================================================================================================
inline Eigen::VectorXd Elem_Pri6::getValueOnIPs(const double* value) {
...
//
// ================================================================================================
inline const double Elem_Pri6::m_weight[m_NumIP] = { -9.0 / 32.0, 25.0 / 96.0, 25.0 / 96.0, 25.0 / 96.0, -9.0 / 32.0, 25.0 / 96.0, 25.0 / 96.0, 25.0 / 96.0 };
