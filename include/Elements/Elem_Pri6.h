...
public:
	/** Constructor for prism linear elements.
	  ...
	  */
	explicit Elem_Pri6(std::shared_ptr<Material>& Material)
...
// 
// ================================================================================================
inline Eigen::VectorXd Elem_Pri6::getShapeFcOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline Eigen::MatrixXd Elem_Pri6::getShapeDerivOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline void Elem_Pri6::setGeomProperties() {
...
//
// ================================================================================================
inline const double Elem_Pri6::m_xsi[m_NumIP][m_Dim] =
...
//
// ================================================================================================
inline const double Elem_Pri6::m_Psi[m_NumIP][m_NumNodes] = {
	...
	{ 0.5 * (1. - m_xsi[7][0] - m_xsi[7][1]) * (1. - m_xsi[7][2]), 0.5 * m_xsi[7][0] * (1. - m_xsi[7][2]), 0.5 * m_xsi[7][1] * (1. - m_xsi[7][2]),
	  0.5 * (1. - m_xsi[7][0] - m_xsi[7][1]) * (1. + m_xsi[7][2]), 0.5 * m_xsi[7][0] * (1. + m_xsi[7][2]), 0.5 * m_xsi[7][1] * (1. + m_xsi[7][2]) },
	{ 0.5 * (1. - m_xsi[8][0] - m_xsi[8][1]) * (1. - m_xsi[8][2]), 0.5 * m_xsi[8][0] * (1. - m_xsi[8][2]), 0.5 * m_xsi[8][1] * (1. - m_xsi[8][2]),
	  0.5 * (1. - m_xsi[8][0] - m_xsi[8][1]) * (1. + m_xsi[8][2]), 0.5 * m_xsi[8][0] * (1. + m_xsi[8][2]), 0.5 * m_xsi[8][1] * (1. + m_xsi[8][2]) },
	{ 0.5 * (1. - m_xsi[9][0] - m_xsi[9][1]) * (1. - m_xsi[9][2]), 0.5 * m_xsi[9][0] * (1. - m_xsi[9][2]), 0.5 * m_xsi[9][1] * (1. - m_xsi[9][2]),
	  0.5 * (1. - m_xsi[9][0] - m_xsi[9][1]) * (1. + m_xsi[9][2]), 0.5 * m_xsi[9][0] * (1. + m_xsi[9][2]), 0.5 * m_xsi[9][1] * (1. + m_xsi[9][2]) },
	{ 0.5 * (1. - m_xsi[10][0] - m_xsi[10][1]) * (1. - m_xsi[10][2]), 0.5 * m_xsi[10][0] * (1. - m_xsi[10][2]), 0.5 * m_xsi[10][1] * (1. - m_xsi[10][2]),
	  0.5 * (1. - m_xsi[10][0] - m_xsi[10][1]) * (1. + m_xsi[10][2]), 0.5 * m_xsi[10][0] * (1. + m_xsi[10][2]), 0.5 * m_xsi[10][1] * (1. + m_xsi[10][2]) },
	{ 0.5 * (1. - m_xsi[11][0] - m_xsi[11][1]) * (1. - m_xsi[11][2]), 0.5 * m_xsi[11][0] * (1. - m_xsi[11][2]), 0.5 * m_xsi[11][1] * (1. - m_xsi[11][2]),
	  0.5 * (1. - m_xsi[11][0] - m_xsi[11][1]) * (1. + m_xsi[11][2]), 0.5 * m_xsi[11][0] * (1. + m_xsi[11][2]), 0.5 * m_xsi[11][1] * (1. + m_xsi[11][2]) },
	{ 0.5 * (1. - m_xsi[12][0] - m_xsi[12][1]) * (1. - m_xsi[12][2]), 0.5 * m_xsi[12][0] * (1. - m_xsi[12][2]), 0.5 * m_xsi[12][1] * (1. - m_xsi[12][2]),
	  0.5 * (1. - m_xsi[12][0] - m_xsi[12][1]) * (1. + m_xsi[12][2]), 0.5 * m_xsi[12][0] * (1. + m_xsi[12][2]), 0.5 * m_xsi[12][1] * (1. + m_xsi[12][2]) },
	{ 0.5 * (1. - m_xsi[13][0] - m_xsi[13][1]) * (1. - m_xsi[13][2]), 0.5 * m_xsi[13][0] * (1. - m_xsi[13][2]), 0.5 * m_xsi[13][1] * (1. - m_xsi[13][2]),
	  0.5 * (1. - m_xsi[13][0] - m_xsi[13][1]) * (1. + m_xsi[13][2]), 0.5 * m_xsi[13][0] * (1. + m_xsi[13][2]), 0.5 * m_xsi[13][1] * (1. + m_xsi[13][2]) },
	{ 0.5 * (1. - m_xsi[14][0] - m_xsi[14][1]) * (1. - m_xsi[14][2]), 0.5 * m_xsi[14][0] * (1. - m_xsi[14][2]), 0.5 * m_xsi[14][1] * (1. - m_xsi[14][2]),
	  0.5 * (1. - m_xsi[14][0] - m_xsi[14][1]) * (1. + m_xsi[14][2]), 0.5 * m_xsi[14][0] * (1. + m_xsi[14][2]), 0.5 * m_xsi[14][1] * (1. + m_xsi[14][2]) },
	{ 0.5 * (1. - m_xsi[15][0] - m_xsi[15][1]) * (1. - m_xsi[15][2]), 0.5 * m_xsi[15][0] * (1. - m_xsi[15][2]), 0.5 * m_xsi[15][1] * (1. - m_xsi[15][2]),
	  0.5 * (1. - m_xsi[15][0] - m_xsi[15][1]) * (1. + m_xsi[15][2]), 0.5 * m_xsi[15][0] * (1. + m_xsi[15][2]), 0.5 * m_xsi[15][1] * (1. + m_xsi[15][2]) },
	{ 0.5 * (1. - m_xsi[16][0] - m_xsi[16][1]) * (1. - m_xsi[16][2]), 0.5 * m_xsi[16][0] * (1. - m_xsi[16][2]), 0.5 * m_xsi[16][1] * (1. - m_xsi[16][2]),
	  0.5 * (1. - m_xsi[16][0] - m_xsi[16][1]) * (1. + m_xsi[16][2]), 0.5 * m_xsi[16][0] * (1. + m_xsi[16][2]), 0.5 * m_xsi[16][1] * (1. + m_xsi[16][2]) },
	{ 0.5 * (1. - m_xsi[17][0] - m_xsi[17][1]) * (1. - m_xsi[17][2]), 0.5 * m_xsi[17][0] * (1. - m_xsi[17][2]), 0.5 * m_xsi[17][1] * (1. - m_xsi[17][2]),
	  0.5 * (1. - m_xsi[17][0] - m_xsi[17][1]) * (1. + m_xsi[17][2]), 0.5 * m_xsi[17][0] * (1. + m_xsi[17][2]), 0.5 * m_xsi[17][1] * (1. + m_xsi[17][2]) } };
...
//
// ================================================================================================
inline const double Elem_Pri6::m_DPsi[m_NumIP][m_NumNodes][m_Dim] =
	{ { { -0.5 * (1. - m_xsi[0][2]), -0.5 * (1. - m_xsi[0][2]), -0.5 * (1. - m_xsi[0][0] - m_xsi[0][1]) },
	  ...
	  { { -0.5 * (1. - m_xsi[8][2]), -0.5 * (1. - m_xsi[8][2]), -0.5 * (1. - m_xsi[8][0] - m_xsi[8][1]) },
		{  0.5 * (1. - m_xsi[8][2]), 0., -0.5 * m_xsi[8][0] },
		{  0., 0.5 * (1. - m_xsi[8][2]), -0.5 * m_xsi[8][1] },
		{ -0.5 * (1. + m_xsi[8][2]), -0.5 * (1. + m_xsi[8][2]), 0.5 * (1. - m_xsi[8][0] - m_xsi[8][1]) },
		{  0.5 * (1. + m_xsi[8][2]), 0., 0.5 * m_xsi[8][0] },
		{  0., 0.5 * (1. + m_xsi[8][2]), 0.5 * m_xsi[8][1] } },

	  { { -0.5 * (1. - m_xsi[9][2]), -0.5 * (1. - m_xsi[9][2]), -0.5 * (1. - m_xsi[9][0] - m_xsi[9][1]) },
		{  0.5 * (1. - m_xsi[9][2]), 0., -0.5 * m_xsi[9][0] },
		{  0., 0.5 * (1. - m_xsi[9][2]), -0.5 * m_xsi[9][1] },
		{ -0.5 * (1. + m_xsi[9][2]), -0.5 * (1. + m_xsi[9][2]), 0.5 * (1. - m_xsi[9][0] - m_xsi[9][1]) },
		{  0.5 * (1. + m_xsi[9][2]), 0., 0.5 * m_xsi[9][0] },
		{  0., 0.5 * (1. + m_xsi[9][2]), 0.5 * m_xsi[9][1] } },

	  { { -0.5 * (1. - m_xsi[10][2]), -0.5 * (1. - m_xsi[10][2]), -0.5 * (1. - m_xsi[10][0] - m_xsi[10][1]) },
		{  0.5 * (1. - m_xsi[10][2]), 0., -0.5 * m_xsi[10][0] },
		{  0., 0.5 * (1. - m_xsi[10][2]), -0.5 * m_xsi[10][1] },
		{ -0.5 * (1. + m_xsi[10][2]), -0.5 * (1. + m_xsi[10][2]), 0.5 * (1. - m_xsi[10][0] - m_xsi[10][1]) },
		{  0.5 * (1. + m_xsi[10][2]), 0., 0.5 * m_xsi[10][0] },
		{  0., 0.5 * (1. + m_xsi[10][2]), 0.5 * m_xsi[10][1] } },

	  { { -0.5 * (1. - m_xsi[11][2]), -0.5 * (1. - m_xsi[11][2]), -0.5 * (1. - m_xsi[11][0] - m_xsi[11][1]) },
		{  0.5 * (1. - m_xsi[11][2]), 0., -0.5 * m_xsi[11][0] },
		{  0., 0.5 * (1. - m_xsi[11][2]), -0.5 * m_xsi[11][1] },
		{ -0.5 * (1. + m_xsi[11][2]), -0.5 * (1. + m_xsi[11][2]), 0.5 * (1. - m_xsi[11][0] - m_xsi[11][1]) },
		{  0.5 * (1. + m_xsi[11][2]), 0., 0.5 * m_xsi[11][0] },
		{  0., 0.5 * (1. + m_xsi[11][2]), 0.5 * m_xsi[11][1] } },

	  { { -0.5 * (1. - m_xsi[12][2]), -0.5 * (1. - m_xsi[12][2]), -0.5 * (1. - m_xsi[12][0] - m_xsi[12][1]) },
		{  0.5 * (1. - m_xsi[12][2]), 0., -0.5 * m_xsi[12][0] },
		{  0., 0.5 * (1. - m_xsi[12][2]), -0.5 * m_xsi[12][1] },
		{ -0.5 * (1. + m_xsi[12][2]), -0.5 * (1. + m_xsi[12][2]), 0.5 * (1. - m_xsi[12][0] - m_xsi[12][1]) },
		{  0.5 * (1. + m_xsi[12][2]), 0., 0.5 * m_xsi[12][0] },
		{  0., 0.5 * (1. + m_xsi[12][2]), 0.5 * m_xsi[12][1] } },

	  { { -0.5 * (1. - m_xsi[13][2]), -0.5 * (1. - m_xsi[13][2]), -0.5 * (1. - m_xsi[13][0] - m_xsi[13][1]) },
		{  0.5 * (1. - m_xsi[13][2]), 0., -0.5 * m_xsi[13][0] },
		{  0., 0.5 * (1. - m_xsi[13][2]), -0.5 * m_xsi[13][1] },
		{ -0.5 * (1. + m_xsi[13][2]), -0.5 * (1. + m_xsi[13][2]), 0.5 * (1. - m_xsi[13][0] - m_xsi[13][1]) },
		{  0.5 * (1. + m_xsi[13][2]), 0., 0.5 * m_xsi[13][0] },
		{  0., 0.5 * (1. + m_xsi[13][2]), 0.5 * m_xsi[13][1] } },

	  { { -0.5 * (1. - m_xsi[14][2]), -0.5 * (1. - m_xsi[14][2]), -0.5 * (1. - m_xsi[14][0] - m_xsi[14][1]) },
		{  0.5 * (1. - m_xsi[14][2]), 0., -0.5 * m_xsi[14][0] },
		{  0., 0.5 * (1. - m_xsi[14][2]), -0.5 * m_xsi[14][1] },
		{ -0.5 * (1. + m_xsi[14][2]), -0.5 * (1. + m_xsi[14][2]), 0.5 * (1. - m_xsi[14][0] - m_xsi[14][1]) },
		{  0.5 * (1. + m_xsi[14][2]), 0., 0.5 * m_xsi[14][0] },
		{  0., 0.5 * (1. + m_xsi[14][2]), 0.5 * m_xsi[14][1] } },

	  { { -0.5 * (1. - m_xsi[15][2]), -0.5 * (1. - m_xsi[15][2]), -0.5 * (1. - m_xsi[15][0] - m_xsi[15][1]) },
		{  0.5 * (1. - m_xsi[15][2]), 0., -0.5 * m_xsi[15][0] },
		{  0., 0.5 * (1. - m_xsi[15][2]), -0.5 * m_xsi[15][1] },
		{ -0.5 * (1. + m_xsi[15][2]), -0.5 * (1. + m_xsi[15][2]), 0.5 * (1. - m_xsi[15][0] - m_xsi[15][1]) },
		{  0.5 * (1. + m_xsi[15][2]), 0., 0.5 * m_xsi[15][0] },
		{  0., 0.5 * (1. + m_xsi[15][2]), 0.5 * m_xsi[15][1] } },

	  { { -0.5 * (1. - m_xsi[16][2]), -0.5 * (1. - m_xsi[16][2]), -0.5 * (1. - m_xsi[16][0] - m_xsi[16][1]) },
		{  0.5 * (1. - m_xsi[16][2]), 0., -0.5 * m_xsi[16][0] },
		{  0., 0.5 * (1. - m_xsi[16][2]), -0.5 * m_xsi[16][1] },
		{ -0.5 * (1. + m_xsi[16][2]), -0.5 * (1. + m_xsi[16][2]), 0.5 * (1. - m_xsi[16][0] - m_xsi[16][1]) },
		{  0.5 * (1. + m_xsi[16][2]), 0., 0.5 * m_xsi[16][0] },
		{  0., 0.5 * (1. + m_xsi[16][2]), 0.5 * m_xsi[16][1] } },

	  { { -0.5 * (1. - m_xsi[17][2]), -0.5 * (1. - m_xsi[17][2]), -0.5 * (1. - m_xsi[17][0] - m_xsi[17][1]) },
		{  0.5 * (1. - m_xsi[17][2]), 0., -0.5 * m_xsi[17][0] },
		{  0., 0.5 * (1. - m_xsi[17][2]), -0.5 * m_xsi[17][1] },
		{ -0.5 * (1. + m_xsi[17][2]), -0.5 * (1. + m_xsi[17][2]), 0.5 * (1. - m_xsi[17][0] - m_xsi[17][1]) },
		{  0.5 * (1. + m_xsi[17][2]), 0., 0.5 * m_xsi[17][0] },
		{  0., 0.5 * (1. + m_xsi[17][2]), 0.5 * m_xsi[17][1] } } };
