...
protected:
	/** Constructor for rectangular linear elements.
	  ...
	  */
	Elem_Rect4(std::shared_ptr<Material>& Material, std::shared_ptr<Section>& Section)
...
public:
	/** Constructor for rectangular linear elements.
	  ...
	  * @param Section Pointer to Section class.
	  */
	explicit Elem_Rect4_IP(std::shared_ptr<Material>& Material, std::shared_ptr<Section>& Section)
...
// 
// ================================================================================================
inline Eigen::VectorXd Elem_Rect4::getShapeFcOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline Eigen::MatrixXd Elem_Rect4::getShapeDerivOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline void Elem_Rect4::setGeomProperties() {
...
// ================================================================================================
template<int nIP>
inline Eigen::VectorXd Elem_Rect4_IP<nIP>::getValueOnIPs(const double* value) {
...
//
// ================================================================================================
template<> const double* Elem_Rect4_IP<4>::m_weight = &Gauss2D::Wg_4P[0];
template<> const double* Elem_Rect4_IP<9>::m_weight = &Gauss2D::Wg_9P[0];
template<> const double* Elem_Rect4_IP<16>::m_weight = &Gauss2D::Wg_16P[0];
