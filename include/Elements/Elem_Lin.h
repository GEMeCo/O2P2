...
public:
	/** Constructor for linear bar elements.
	  ...
	  */
	explicit Elem_Lin(std::shared_ptr<Material>& Material, std::shared_ptr<Section>& Section)
...
// 
// ================================================================================================
template<> inline Eigen::VectorXd Elem_Lin<2, 2, 2>::getShapeFcOnPoint(const double* Point) {
...
template<> inline Eigen::VectorXd Elem_Lin<2, 2, 3>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(2);
...
template<> inline Eigen::VectorXd Elem_Lin<2, 2, 4>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(2);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 2, 2>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(2);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 2, 3>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(2);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 2, 4>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(2);
...
template<> inline Eigen::VectorXd Elem_Lin<2, 3, 2>::getShapeFcOnPoint(const double* Point) {
...
template<> inline Eigen::VectorXd Elem_Lin<2, 3, 3>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(3);
...
template<> inline Eigen::VectorXd Elem_Lin<2, 3, 4>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(3);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 3, 2>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(3);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 3, 3>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(3);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 3, 4>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(3);
...
template<> inline Eigen::VectorXd Elem_Lin<2, 4, 2>::getShapeFcOnPoint(const double* Point) {
...
template<> inline Eigen::VectorXd Elem_Lin<2, 4, 3>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(4);
...
template<> inline Eigen::VectorXd Elem_Lin<2, 4, 4>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(4);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 4, 2>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(4);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 4, 3>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(4);
...
template<> inline Eigen::VectorXd Elem_Lin<3, 4, 4>::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(4);
...
// 
// ================================================================================================
template<> inline Eigen::MatrixXd Elem_Lin<2, 2, 2>::getShapeDerivOnPoint(const double* Point) {
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 2, 3>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(2, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 2, 4>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(2, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 2, 2>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(2, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 2, 3>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(2, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 2, 4>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(2, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 3, 2>::getShapeDerivOnPoint(const double* Point) {
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 3, 3>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(3, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 3, 4>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(3, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 3, 2>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(3, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 3, 3>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(3, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 3, 4>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(3, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 4, 2>::getShapeDerivOnPoint(const double* Point) {
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 4, 3>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(4, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<2, 4, 4>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(4, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 4, 2>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(4, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 4, 3>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(4, 1);
...
template<> inline Eigen::MatrixXd Elem_Lin<3, 4, 4>::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(4, 1);
...
//
// ================================================================================================
template<> const double* Elem_Lin<2, 2, 2>::m_weight = &Gauss1D::Wg_2P[0];
template<> const double* Elem_Lin<2, 3, 2>::m_weight = &Gauss1D::Wg_2P[0];
template<> const double* Elem_Lin<2, 4, 2>::m_weight = &Gauss1D::Wg_2P[0];

template<> const double* Elem_Lin<2, 2, 3>::m_weight = &Gauss1D::Wg_3P[0];
template<> const double* Elem_Lin<2, 3, 3>::m_weight = &Gauss1D::Wg_3P[0];
template<> const double* Elem_Lin<2, 4, 3>::m_weight = &Gauss1D::Wg_3P[0];

template<> const double* Elem_Lin<2, 2, 4>::m_weight = &Gauss1D::Wg_4P[0];
template<> const double* Elem_Lin<2, 3, 4>::m_weight = &Gauss1D::Wg_4P[0];
template<> const double* Elem_Lin<2, 4, 4>::m_weight = &Gauss1D::Wg_4P[0];

template<> const double* Elem_Lin<3, 2, 2>::m_weight = &Gauss1D::Wg_2P[0];
template<> const double* Elem_Lin<3, 3, 2>::m_weight = &Gauss1D::Wg_2P[0];
template<> const double* Elem_Lin<3, 4, 2>::m_weight = &Gauss1D::Wg_2P[0];

template<> const double* Elem_Lin<3, 2, 3>::m_weight = &Gauss1D::Wg_3P[0];
template<> const double* Elem_Lin<3, 3, 3>::m_weight = &Gauss1D::Wg_3P[0];
template<> const double* Elem_Lin<3, 4, 3>::m_weight = &Gauss1D::Wg_3P[0];

template<> const double* Elem_Lin<3, 2, 4>::m_weight = &Gauss1D::Wg_4P[0];
template<> const double* Elem_Lin<3, 3, 4>::m_weight = &Gauss1D::Wg_4P[0];
template<> const double* Elem_Lin<3, 4, 4>::m_weight = &Gauss1D::Wg_4P[0];
...
template<> const double Elem_Lin<2, 2, 4>::m_Psi[4][2] = {
...
template<> const double Elem_Lin<3, 2, 2>::m_Psi[2][2] = {
	{ 0.5 - 0.5 * Gauss1D::Qsi_2P[0], 0.5 + 0.5 * Gauss1D::Qsi_2P[0] } ,
	{ 0.5 - 0.5 * Gauss1D::Qsi_2P[1], 0.5 + 0.5 * Gauss1D::Qsi_2P[1] } };

template<> const double Elem_Lin<3, 2, 3>::m_Psi[3][2] = {
	{ 0.5 - 0.5 * Gauss1D::Qsi_3P[0], 0.5 + 0.5 * Gauss1D::Qsi_3P[0] } ,
	{ 0.5 - 0.5 * Gauss1D::Qsi_3P[1], 0.5 + 0.5 * Gauss1D::Qsi_3P[1] } ,
	{ 0.5 - 0.5 * Gauss1D::Qsi_3P[2], 0.5 + 0.5 * Gauss1D::Qsi_3P[2] } };

template<> const double Elem_Lin<3, 2, 4>::m_Psi[4][2] = {
	{ 0.5 - 0.5 * Gauss1D::Qsi_4P[0], 0.5 + 0.5 * Gauss1D::Qsi_4P[0] } ,
	{ 0.5 - 0.5 * Gauss1D::Qsi_4P[1], 0.5 + 0.5 * Gauss1D::Qsi_4P[1] } ,
	{ 0.5 - 0.5 * Gauss1D::Qsi_4P[2], 0.5 + 0.5 * Gauss1D::Qsi_4P[2] } ,
	{ 0.5 - 0.5 * Gauss1D::Qsi_4P[3], 0.5 + 0.5 * Gauss1D::Qsi_4P[3] } };

template<> const double Elem_Lin<2, 3, 2>::m_Psi[2][3] = {
...
template<> const double Elem_Lin<2, 3, 3>::m_Psi[3][3] = {
...
template<> const double Elem_Lin<2, 3, 4>::m_Psi[4][3] = {
...
template<> const double Elem_Lin<3, 3, 2>::m_Psi[2][3] = {
	{ 0.5 * (Gauss1D::Qsi_2P[0] - 1.) * Gauss1D::Qsi_2P[0], 0.5 * (Gauss1D::Qsi_2P[0] + 1.) * Gauss1D::Qsi_2P[0],  (1. + Gauss1D::Qsi_2P[0]) * (1. - Gauss1D::Qsi_2P[0]) },
	{ 0.5 * (Gauss1D::Qsi_2P[1] - 1.) * Gauss1D::Qsi_2P[1], 0.5 * (Gauss1D::Qsi_2P[1] + 1.) * Gauss1D::Qsi_2P[1],  (1. + Gauss1D::Qsi_2P[1]) * (1. - Gauss1D::Qsi_2P[1]) } };

template<> const double Elem_Lin<3, 3, 3>::m_Psi[3][3] = {
	{ 0.5 * (Gauss1D::Qsi_3P[0] - 1.) * Gauss1D::Qsi_3P[0], 0.5 * (Gauss1D::Qsi_3P[0] + 1.) * Gauss1D::Qsi_3P[0],  (1. + Gauss1D::Qsi_3P[0]) * (1. - Gauss1D::Qsi_3P[0]) },
	{ 0.5 * (Gauss1D::Qsi_3P[1] - 1.) * Gauss1D::Qsi_3P[1], 0.5 * (Gauss1D::Qsi_3P[1] + 1.) * Gauss1D::Qsi_3P[1],  (1. + Gauss1D::Qsi_3P[1]) * (1. - Gauss1D::Qsi_3P[1]) },
	{ 0.5 * (Gauss1D::Qsi_3P[2] - 1.) * Gauss1D::Qsi_3P[2], 0.5 * (Gauss1D::Qsi_3P[2] + 1.) * Gauss1D::Qsi_3P[2],  (1. + Gauss1D::Qsi_3P[2]) * (1. - Gauss1D::Qsi_3P[2]) } };

template<> const double Elem_Lin<3, 3, 4>::m_Psi[4][3] = {
	{ 0.5 * (Gauss1D::Qsi_4P[0] - 1.) * Gauss1D::Qsi_4P[0], 0.5 * (Gauss1D::Qsi_4P[0] + 1.) * Gauss1D::Qsi_4P[0],  (1. + Gauss1D::Qsi_4P[0]) * (1. - Gauss1D::Qsi_4P[0]) },
	{ 0.5 * (Gauss1D::Qsi_4P[1] - 1.) * Gauss1D::Qsi_4P[1], 0.5 * (Gauss1D::Qsi_4P[1] + 1.) * Gauss1D::Qsi_4P[1],  (1. + Gauss1D::Qsi_4P[1]) * (1. - Gauss1D::Qsi_4P[1]) },
	{ 0.5 * (Gauss1D::Qsi_4P[2] - 1.) * Gauss1D::Qsi_4P[2], 0.5 * (Gauss1D::Qsi_4P[2] + 1.) * Gauss1D::Qsi_4P[2],  (1. + Gauss1D::Qsi_4P[2]) * (1. - Gauss1D::Qsi_4P[2]) },
	{ 0.5 * (Gauss1D::Qsi_4P[3] - 1.) * Gauss1D::Qsi_4P[3], 0.5 * (Gauss1D::Qsi_4P[3] + 1.) * Gauss1D::Qsi_4P[3],  (1. + Gauss1D::Qsi_4P[3]) * (1. - Gauss1D::Qsi_4P[3]) } };

template<> const double Elem_Lin<2, 4, 2>::m_Psi[2][4] = {
...
template<> const double Elem_Lin<2, 4, 3>::m_Psi[3][4] = {
...
template<> const double Elem_Lin<2, 4, 4>::m_Psi[4][4] = {
...
template<> const double Elem_Lin<3, 4, 2>::m_Psi[2][4] = {
	{ -0.0625 + Gauss1D::Qsi_2P[0] / 16.0 + (9.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0,
	   0.5625 - (27.0 * Gauss1D::Qsi_2P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0 + (27.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0,
	   0.5625 + (27.0 * Gauss1D::Qsi_2P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0 - (27.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0,
	  -0.0625 - Gauss1D::Qsi_2P[0] / 16.0 + (9.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0 + (9.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0 },
...
template<> const double Elem_Lin<3, 4, 3>::m_Psi[3][4] = {
	{ -0.0625 + Gauss1D::Qsi_3P[0] / 16.0 + (9.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0,
	   0.5625 - (27.0 * Gauss1D::Qsi_3P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0 + (27.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0,
	   0.5625 + (27.0 * Gauss1D::Qsi_3P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0 - (27.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0,
	  -0.0625 - Gauss1D::Qsi_3P[0] / 16.0 + (9.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0 + (9.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0 },
...
template<> const double Elem_Lin<3, 4, 4>::m_Psi[4][4] = {
	{ -0.0625 + Gauss1D::Qsi_4P[0] / 16.0 + (9.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0,
	   0.5625 - (27.0 * Gauss1D::Qsi_4P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0 + (27.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0,
	   0.5625 + (27.0 * Gauss1D::Qsi_4P[0]) / 16.0 - (9.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0 - (27.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0,
	  -0.0625 - Gauss1D::Qsi_4P[0] / 16.0 + (9.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0 + (9.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0 },
...
//
// ================================================================================================
template<> const double Elem_Lin<2, 2, 2>::m_DPsi[2][2] = {
	{ -0.5, 0.5 }, { -0.5, 0.5 } };

template<> const double Elem_Lin<2, 2, 3>::m_DPsi[3][2] = {
	{ -0.5, 0.5 }, { -0.5, 0.5 }, { -0.5, 0.5 } };

template<> const double Elem_Lin<2, 2, 4>::m_DPsi[4][2] = {
	{ -0.5, 0.5 }, { -0.5, 0.5 }, { -0.5, 0.5 }, { -0.5, 0.5 } };

template<> const double Elem_Lin<3, 2, 2>::m_DPsi[2][2] = {
	{ -0.5, 0.5 }, { -0.5, 0.5 } };

template<> const double Elem_Lin<3, 2, 3>::m_DPsi[3][2] = {
	{ -0.5, 0.5 }, { -0.5, 0.5 }, { -0.5, 0.5 } };

template<> const double Elem_Lin<3, 2, 4>::m_DPsi[4][2] = {
	{ -0.5, 0.5 }, { -0.5, 0.5 }, { -0.5, 0.5 }, { -0.5, 0.5 } };

template<> const double Elem_Lin<2, 3, 2>::m_DPsi[2][3] = {
	{ Gauss1D::Qsi_2P[0] - 0.5, Gauss1D::Qsi_2P[0] + 0.5, -2. * Gauss1D::Qsi_2P[0] },
	{ Gauss1D::Qsi_2P[1] - 0.5, Gauss1D::Qsi_2P[1] + 0.5, -2. * Gauss1D::Qsi_2P[1] } };

template<> const double Elem_Lin<2, 3, 3>::m_DPsi[3][3] = {
...
template<> const double Elem_Lin<2, 3, 4>::m_DPsi[4][3] = {
...
template<> const double Elem_Lin<3, 3, 2>::m_DPsi[2][3] = {
	{ Gauss1D::Qsi_2P[0] - 0.5, Gauss1D::Qsi_2P[0] + 0.5, -2. * Gauss1D::Qsi_2P[0] },
	{ Gauss1D::Qsi_2P[1] - 0.5, Gauss1D::Qsi_2P[1] + 0.5, -2. * Gauss1D::Qsi_2P[1] } };

template<> const double Elem_Lin<3, 3, 3>::m_DPsi[3][3] = {
	{ Gauss1D::Qsi_3P[0] - 0.5, Gauss1D::Qsi_3P[0] + 0.5, -2. * Gauss1D::Qsi_3P[0] },
	{ Gauss1D::Qsi_3P[1] - 0.5, Gauss1D::Qsi_3P[1] + 0.5, -2. * Gauss1D::Qsi_3P[1] },
	{ Gauss1D::Qsi_3P[2] - 0.5, Gauss1D::Qsi_3P[2] + 0.5, -2. * Gauss1D::Qsi_3P[2] } };

template<> const double Elem_Lin<3, 3, 4>::m_DPsi[4][3] = {
	{ Gauss1D::Qsi_4P[0] - 0.5, Gauss1D::Qsi_4P[0] + 0.5, -2. * Gauss1D::Qsi_4P[0] },
	{ Gauss1D::Qsi_4P[1] - 0.5, Gauss1D::Qsi_4P[1] + 0.5, -2. * Gauss1D::Qsi_4P[1] },
	{ Gauss1D::Qsi_4P[2] - 0.5, Gauss1D::Qsi_4P[2] + 0.5, -2. * Gauss1D::Qsi_4P[2] },
	{ Gauss1D::Qsi_4P[3] - 0.5, Gauss1D::Qsi_4P[3] + 0.5, -2. * Gauss1D::Qsi_4P[3] } };

template<> const double Elem_Lin<2, 4, 2>::m_DPsi[2][4] = {
...
template<> const double Elem_Lin<2, 4, 3>::m_DPsi[3][4] = {
...
template<> const double Elem_Lin<2, 4, 4>::m_DPsi[4][4] = {
...
template<> const double Elem_Lin<3, 4, 2>::m_DPsi[2][4] = {
	{ 0.0625 + (9.0 * Gauss1D::Qsi_2P[0]) / 8.0 - (27.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0,
	 -1.6875 - (9.0 * Gauss1D::Qsi_2P[0]) / 8.0 + (81.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0,
	  1.6875 - (9.0 * Gauss1D::Qsi_2P[0]) / 8.0 - (81.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0,
	 -0.0625 + (9.0 * Gauss1D::Qsi_2P[0]) / 8.0 + (27.0 * Gauss1D::Qsi_2P[0] * Gauss1D::Qsi_2P[0]) / 16.0 },
...
template<> const double Elem_Lin<3, 4, 3>::m_DPsi[3][4] = {
	{ 0.0625 + (9.0 * Gauss1D::Qsi_3P[0]) / 8.0 - (27.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0,
	 -1.6875 - (9.0 * Gauss1D::Qsi_3P[0]) / 8.0 + (81.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0,
	  1.6875 - (9.0 * Gauss1D::Qsi_3P[0]) / 8.0 - (81.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0,
	 -0.0625 + (9.0 * Gauss1D::Qsi_3P[0]) / 8.0 + (27.0 * Gauss1D::Qsi_3P[0] * Gauss1D::Qsi_3P[0]) / 16.0 },
...
template<> const double Elem_Lin<3, 4, 4>::m_DPsi[4][4] = {
	{ 0.0625 + (9.0 * Gauss1D::Qsi_4P[0]) / 8.0 - (27.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0,
	 -1.6875 - (9.0 * Gauss1D::Qsi_4P[0]) / 8.0 + (81.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0,
	  1.6875 - (9.0 * Gauss1D::Qsi_4P[0]) / 8.0 - (81.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0,
	 -0.0625 + (9.0 * Gauss1D::Qsi_4P[0]) / 8.0 + (27.0 * Gauss1D::Qsi_4P[0] * Gauss1D::Qsi_4P[0]) / 16.0 },
