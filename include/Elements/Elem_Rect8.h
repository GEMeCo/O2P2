...
public:
	/** Constructor for rectangular cubic / linear elements.
	  ...
	  */
	explicit Elem_Rect8(std::shared_ptr<Material>& Material, std::shared_ptr<Section>& Section)
...
// 
// ================================================================================================
inline Eigen::VectorXd Elem_Rect8::getShapeFcOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline Eigen::MatrixXd Elem_Rect8::getShapeDerivOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline void Elem_Rect8::setGeomProperties() {
...
// 
// ================================================================================================
inline Eigen::VectorXd Elem_Rect8::getValueOnIPs(const double* value) {
...
//
// ================================================================================================
inline const double Elem_Rect8::m_xsi[m_NumIP][m_Dim] = { { -0.861136311594053, -0.577350269189626 } ,
...
//
// ================================================================================================
inline const double Elem_Rect8::m_weight[m_NumIP] = { 0.347854845137454, 0.347854845137454, 0.347854845137454, 0.347854845137454, 0.652145154862546, 0.652145154862546, 0.652145154862546, 0.652145154862546 };
...
//
// ================================================================================================
inline const double Elem_Rect8::m_Psi[m_NumIP][m_NumNodes] = {
...
//
// ================================================================================================
inline const double Elem_Rect8::m_DPsi[m_NumIP][m_NumNodes][m_Dim] = {
