...
// 
// ================================================================================================
inline Eigen::VectorXd O2P2::Prep::Elem::Elem_Tri6::getShapeFcOnPoint(const double* Point) {
	Eigen::VectorXd Psi(6);

	Psi(0) = (1. - 2. * Point[0] - 2. * Point[1]) * (1. - Point[0] - Point[1]);
	Psi(1) = 4. * Point[0] * (1. - Point[0] - Point[1]);
	Psi(2) = (2. * Point[0] - 1.) * Point[0];
	Psi(3) = 4. * Point[1] * (1. - Point[0] - Point[1]);
...
// 
// ================================================================================================
inline Eigen::MatrixXd O2P2::Prep::Elem::Elem_Tri6::getShapeDerivOnPoint(const double* Point) {
	Eigen::MatrixXd DPsi(6, 2);

	DPsi(0, 0) = -3. + 4. * (Point[0] + Point[1]);
	DPsi(1, 0) = 4. - 4. * (2. * Point[0] + Point[1]);
	DPsi(2, 0) = 4. * Point[0] - 1.;
	DPsi(3, 0) = -4. * Point[1];
	DPsi(4, 0) = 4. * Point[1];
	DPsi(5, 0) = 0.;

	DPsi(0, 1) = -3. + 4. * (Point[0] + Point[1]);
	DPsi(1, 1) = -4. * Point[0];
	DPsi(2, 1) = 0.;
	DPsi(3, 1) = 4. - 4. * (Point[0] + 2. * Point[1]);
	DPsi(4, 1) = 4. * Point[0];
...
// ================================================================================================
template<int nIP>
inline Eigen::VectorXd O2P2::Prep::Elem::Elem_Tri6_IP<nIP>::getValueOnIPs(const double* value) {
...
//
// ================================================================================================
template<> const double* O2P2::Prep::Elem::Elem_Tri6_IP<3>::m_weight = &Hammer2D::Wg_3P[0];
template<> const double* O2P2::Prep::Elem::Elem_Tri6_IP<4>::m_weight = &Hammer2D::Wg_4P[0];
template<> const double* O2P2::Prep::Elem::Elem_Tri6_IP<6>::m_weight = &Hammer2D::Wg_6P[0];
template<> const double* O2P2::Prep::Elem::Elem_Tri6_IP<7>::m_weight = &Hammer2D::Wg_7P[0];
template<> const double* O2P2::Prep::Elem::Elem_Tri6_IP<12>::m_weight = &Hammer2D::Wg_12P[0];
template<> const double* O2P2::Prep::Elem::Elem_Tri6_IP<13>::m_weight = &Hammer2D::Wg_13P[0];
...
//
// ================================================================================================
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<3>::m_Psi[3][m_NumNodes] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<4>::m_Psi[4][m_NumNodes] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<6>::m_Psi[6][m_NumNodes] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<7>::m_Psi[7][m_NumNodes] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<12>::m_Psi[12][m_NumNodes] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<13>::m_Psi[13][m_NumNodes] = {
...
//
// ================================================================================================
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<3>::m_DPsi[3][m_NumNodes][m_Dim] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<4>::m_DPsi[4][m_NumNodes][m_Dim] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<6>::m_DPsi[6][m_NumNodes][m_Dim] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<7>::m_DPsi[7][m_NumNodes][m_Dim] = {
...
template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<12>::m_DPsi[12][m_NumNodes][m_Dim] = {
	...
	{ { -3. + 4. * (Hammer2D::Qsi_12P[11][0] + Hammer2D::Qsi_12P[11][1]) , -3. + 4. * (Hammer2D::Qsi_12P[11][0] + Hammer2D::Qsi_12P[11][1]) },
	  ...
	  template<> const double O2P2::Prep::Elem::Elem_Tri6_IP<13>::m_DPsi[13][m_NumNodes][m_Dim] = {
