...
public:
	...
	/** Get a single node from the Node container index.
	  ...
	  */
	const Node<nDim>* getNode(const size_t& index) {
	...
	/** Get access to the container of nodes.
	  ...
	  */
	std::vector<std::shared_ptr<Node<nDim>>>& getNode() { return v_Node; };
	...
	/** Get a single element from the Element container index.
	  ...
	  */
	Element<nDim>* getElem(const size_t& index) { return v_Elem.at(index).get(); };
	...
	/** Get access to the container of elements.
	  ...
	  */
	std::vector<std::shared_ptr<Element<nDim>>>& getElem() { return v_Elem; };
...
private:
	...
	std::vector<std::shared_ptr<Node<nDim>>> v_Node;

	// Container of Material objects.
	std::vector<std::shared_ptr<Material>> v_Mat;

	// Container of Section objects.
	std::vector<std::shared_ptr<Section>> v_Sect;

	// Container of Element objects.
	std::vector<std::shared_ptr<Element<nDim>>> v_Elem;
};
