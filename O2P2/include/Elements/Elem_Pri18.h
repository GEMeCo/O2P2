		...
		namespace Elem {
			...
			public:
				/** Constructor for prism quadratic elements.
				  ...
				  */
				explicit Elem_Pri18(std::shared_ptr<O2P2::Prep::Material>& Material)
...
// 
// ================================================================================================
inline std::vector<double> O2P2::Prep::Elem::Elem_Pri18::getShapeFcOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline std::vector<double> O2P2::Prep::Elem::Elem_Pri18::getShapeDerivOnPoint(const double* Point) {
...
// 
// ================================================================================================
inline void O2P2::Prep::Elem::Elem_Pri18::setGeomProperties() {
...
// 
// ================================================================================================
inline std::vector<double> O2P2::Prep::Elem::Elem_Pri18::getValueOnIPs(const double* value) {
...
//
// ================================================================================================
inline const double O2P2::Prep::Elem::Elem_Pri18::m_xsi[mv_numIP][mv_Dim] =
...
//
// ================================================================================================
inline const double O2P2::Prep::Elem::Elem_Pri18::mv_Psi[mv_numIP][mv_numNodes] = {
...
//
// ================================================================================================
inline const double O2P2::Prep::Elem::Elem_Pri18::mv_DPsi[mv_numIP][mv_numNodes][mv_Dim] = {
